			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
							Your daily favorites serves here!
						</p>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>
						Welcome to NAOMI PIZZA where passion meets pizza perfection. Founded in 2024, we are a family-owned pizzeria dedicated to crafting authentic, mouthwatering pizzas that delight the senses. Our journey began with a simple vision: to bring the true taste of Italy to our community.
Every pizza we create is a labour of love, starting with handcrafted dough made from the finest ingredients.</p>
<p>At NAOMI PIZZA, we don't just serve pizza; we create unforgettable dining experiences. From our cozy ambiance to our friendly staff, we strive to make every visit a memorable one. Join us and experience the essence of authentic Italian cuisine, one slice at a time.
Come taste the difference at NAOMI PIZZA, where every bite tells a story of tradition, quality, and passion.</p> <p>BEST IN BOR TOWN!</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/1logo.png" alt="Restaurant Logo" style="width: 150px;margin-bottom: 20px;">
                        <p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday - Friday 11:30am - 4:00pm</li>
                            <li>Monday - Friday 11:30am - 4:00pm</li>
                            <li>Monday - Friday 11:30am - 4:00pm</li>
                            <li>Monday - Friday 11:30am - 4:00pm</li>
                        </ul>
